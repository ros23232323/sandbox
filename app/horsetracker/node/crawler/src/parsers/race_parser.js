...
module.exports = {
  parse: function(html, options){
      ...
      race.race_name = $('.content-header h2').text().split(' ')[0];
      race.race_distance = $('.content-header h2').text().split(' ')[1];
      race.prize_money = $('.content-header ul li:nth-child(2)').text().replace(/(\n|\s+)/g,' ').trim();
      race.race_going = $('.content-header ul li:nth-child(3)').text();
      race.race_surface = $('.content-header ul li:nth-child(4)').text();
      race.race_time = $('.header-nav h1').text().split(' ')[0]
