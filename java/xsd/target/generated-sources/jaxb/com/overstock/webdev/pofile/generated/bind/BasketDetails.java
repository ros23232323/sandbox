 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}BasketItem" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "BasketDetails")
public class BasketDetails {

    @XmlElement(name = "BasketItem", required = true)
    protected List<BasketItem> basketItem;
    ...
    public List<BasketItem> getBasketItem() {
        if (basketItem == null) {
            basketItem = new ArrayList<BasketItem>();
        }
